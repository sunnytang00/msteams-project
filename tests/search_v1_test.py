...
def test_empty_query_str(helper):
    ...
    ch1 = channels_create_v1(user_id, "test channel", True)['channel_id']
...
def test_no_match(helper):
    ...
    test_channel = channels_create_v1(user_id, "test channel", True)['channel_id']
    channel_id = channel['channel_id']

    message_send_v1(user_id, channel_id, "Hello1")

    assert search_v1(user_id, "Hello") == {'messages':[]}
...
def test_one_match(helper):
    ...
    test_channel = channels_create_v1(user_id, "correct", True)['channel_id']
