...
def test_valid_input():
    ...
    channel_removeowner_v1(auth_user_id, ch_id, user_id2)
...
def test_invalid_token():
    ...
    with pytest.raises(AccessError) as e: 
        channel_removeowner_v1(auth_user_id + 10, ch_id, user_id2)
...
def test_auth_user_has_no_access():
    ...
    channel_addowner_v1(user_id2, ch_id, auth_user_id)

    with pytest.raises(AccessError) as e: 
        channel_removeowner_v1(user_id3, ch_id, auth_user_id)
