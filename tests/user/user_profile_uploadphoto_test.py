...
from src.user import user_profile_v1, user_profile_uploadphoto_v1
...
def test_wrong_dimension(helper):
    auth_user_id = helper.register_user(1)
    url = "http://pn.gexing.com/G1/M00/AF/36/rBACFFZnl53xA2y3AABgimrtu8Q395.jpg"
    x_start = 0
    y_start = 0
    x_end = 1000
    y_end = 1000
...
def test_img_not_jpg(helper):
    auth_user_id = helper.register_user(1)
    url = "https://pngimg.com/uploads/light/light_PNG14440.png"
    x_start = 0
    y_start = 0
    x_end = 1000
    y_end = 1000
